...
CXXFLAGS = -g -O2 -D__NBISLE__ -DLINUX -fPIC $(INCLUDE) -I$(PROJECT_ROOT)/../src/include -I$(PROJECT_ROOT)/../libFRFXLL/include -I$(PROJECT_ROOT)/../biomdi/common/src/include -I$(PROJECT_ROOT)/../biomdi/fingerminutia/src/include -fmax-errors=10 -std=c++11
...
ALL_LIBS = $(LIB) -L$(PROJECT_ROOT)/../biomdi/common/lib -L$(PROJECT_ROOT)/../biomdi/fingerminutia/lib -lbiomdi -lfmr -L$(PROJECT_ROOT)/../libFRFXLL/lib -lFRFXLL -lopencv_core -lopencv_calib3d  -lopencv_features2d -lopencv_flann -lopencv_highgui -lopencv_imgproc -lopencv_imgcodecs -lopencv_videoio -lopencv_ml -lopencv_objdetect -lopencv_photo -lopencv_stitching  -lopencv_video -lopencv_videostab

#-lopencv_ts -lopencv_contrib

LDFLAGS := -Wl,-rpath,$(shell readlink -f $(PROJECT_ROOT)/../biomdi/fingerminutia/lib) -Wl,-rpath,$(shell readlink -f $(PROJECT_ROOT)/../biomdi/common/lib) 
#-Wl,-rpath,$(shell readlink -f $(PROJECT_ROOT)/../libOpenCV/lib)
